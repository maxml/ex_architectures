import 'package:ex_architectures/mvp/presenter.dart';
...
class _HomePageState extends State<HomePage> implements IView {
    ...
    var _resultView = Column(
      children: <Widget>[
        ...
        Center(
          child: Text(
            '$_message',
            style: TextStyle(color: Colors.lightGreen, fontSize: 24.0, fontWeight: FontWeight.w600),
          ),
        )
      ],
    );
